...
const http = require('http');
    ...
    console.log(` HuseynWinner Music`);
...
client.on('message', async msg => {
    ...
    .setTitle(':warning: | İlk olarak sesli bir kanala giriş yapmanız gerek.'));
      ...
      .setTitle(`**✅ | Oynatma Listesi: **${playlist.title}** Kuyruğa Eklendi!**`)
         ...
         .setTitle(' PloweS Bot  | Şarkı Seçimi')
          ...
          msg.delete(5000)
					try {
						...
						console.error(err);
						 return msg.channel.sendEmbed(new Discord.RichEmbed()
            .setColor('#FFCC00')
            .setDescription('<a:hayir31:724972661868068945> | **Şarkı Değeri Belirtmediğiniz İçin Seçim İptal Edilmiştir**.'));
                    }
    ...
    .setColor('#FFCC00')
    .setDescription(' <a:hayir31:724972661868068945> | **Lütfen öncelikle sesli bir kanala katılınız**.'));
    ...
    .setDescription(':warning: **| Lütfen öncelikle sesli bir kanala katılınız.**'));
		if (!serverQueue) return msg.channel.sendEmbed(new Discord.RichEmbed()
     .setColor('#FFCC00')
     .setTitle('<a:hayir31:724972661868068945> | **Hiç Bir Müzik Çalmamakta**'));                                              
   ...
   .setTitle(`:warning: Şuanki Ses Seviyesi: **${serverQueue.volume}**`)
    ...
    .setColor('#FFCC00'));                             
		...
		if (!serverQueue) return msg.channel.sendEmbed(new Discord.RichEmbed()
    .setTitle("<a:hayir31:724972661868068945> | **Çalan Müzik Bulunmamakta**")
    .setColor('RANDOM'));
		return msg.channel.sendEmbed(new Discord.RichEmbed()
    .setColor('#FFCC00')
    .setTitle("  PloweS Bot | Çalan")                            
    .addField('Başlık', `[${serverQueue.songs[0].title}](${serverQueue.songs[0].url})`, true)
    .addField("Süre", `${serverQueue.songs[0].durationm}:${serverQueue.songs[0].durations}`, true))
	} else if (command === 'sıra') { // queue komutu
    let index = 0;
		if (!serverQueue) return msg.channel.sendEmbed(new Discord.RichEmbed()
    .setTitle("<a:hayir31:724972661868068945> | **Sırada Müzik Bulunmamakta**")
    .setColor('#FFCC00'));
		  return msg.channel.sendEmbed(new Discord.RichEmbed()
    .setColor('RANDOM')
     .setTitle(' PloweS Bot | Şarkı Kuyruğu')
...
function play(guild, song) {
	...
	const dispatcher = serverQueue.connection.playStream(ytdl(song.url))
		.on('end', reason => {
			if (reason === ' <a:hayir31:724972661868068945>  | **Yayın Akış Hızı Yeterli Değil.**') console.log('Müzik Bitti.');
  ...
  .setTitle("** PloweS Bot  | 🎙 Müzik Başladı**",`https://cdn.discordapp.com/avatars/473974675194511361/6bb90de9efe9fb80081b185266bb94a6.png?size=2048`)
